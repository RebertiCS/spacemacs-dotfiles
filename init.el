...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     helm
     lsp
     (python :variables python-formatter 'yapf python-format-on-save t)
     html
     django
     markdown
     multiple-cursors
...
before packages are loaded."
  ...
  (setq-lsp-pylsp-plugins-flake8-ignore ["D203"])
)
